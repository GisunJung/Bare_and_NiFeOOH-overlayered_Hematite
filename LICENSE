...
(All definitions as per the standard CC BY 4.0 license text)
...
a. retain identification of the creator(s) of the Licensed Material and any others designated to receive attribution;
...
(As per the standard CC BY 4.0 license text)
...
A full copy of the license text can be found at:
